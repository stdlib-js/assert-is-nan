...
```javascript
isnan = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-nan@v0.2.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/assert-is-nan/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/assert-is-nan/actions/workflows/test.yml?query=branch:v0.2.3
