...
```javascript
import isnan from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-nan@v0.2.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { isObject, isPrimitive } from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-nan@v0.2.1-deno/mod.js';
```
